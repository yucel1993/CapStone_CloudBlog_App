...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/burhan/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/burhan/capstone/password", WithDecryption=True)
